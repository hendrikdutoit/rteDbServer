...
ssh -t -E %_app_root_dir%\src\rteDbServer\rteDbServer.log root@159.65.212.97 "ufw enable;ufw allow OpenSSH;apt update;apt install openssh-server;ufw allow 22;systemctl start ssh"
scp %_app_root_dir%\src\rteDbServer\rteDbServer_s1*.* root@159.65.212.97://usr/local/share
scp %_app_root_dir%\data\.netrc root@159.65.212.97:~/.netrc
